...
class Data {
    ...
    public:
        ...
        // I2C pins for OLED display: B6 (SCL), B7 (SDA) - automatically handled by Wire library
        ...
        static const unsigned long displayUpdateIntervalMs = 500; // interval in milliseconds for regular display update, also used to check if display needs update

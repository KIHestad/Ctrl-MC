...
class Data {
    ...
    public:
        ...
        // Main properties
        static const int pinButton = 33; // Pin for button input
        static const int pinDhtSensor = 27; // Pin for DHT22 sensor input
        static const int pinWheelSensor = 21; // Pin for wheel sensor input
        static const int pinRpmSensor = 25; // Pin for rpm sensor input
        ...
        static const unsigned long displayUpdateIntervalMs = 250; // interval in milliseconds for regular display update, also used to check if display needs update
        unsigned long displayRpmUpdatePreviousMs = 0; // previous time in milliseconds for rpm only update
        static const unsigned long displayRpmUpdateIntervalMs = 100; // interval in milliseconds
        static const unsigned int displayPagesTotal = 5; // total number of display pages
        ...
        static const unsigned long displayMenuNameTimoutMs = 5000; // time in milliseconds to show menu name after page change
        ...
        static const unsigned long displayPageSelectedShowTimeMs = 5000; // time in milliseconds to show page name after page change
        ...
        volatile unsigned int pulseRpmReadings[pulseRpmReadingsCount] = {0};
        ...
        // Properties for hall sensor reading wheel rotations using interrupt
        static const int pulseWheelReadingsCount = 5; // Buffer size for wheel speed readings
        volatile unsigned long pulseWheelReadings[pulseWheelReadingsCount] = {0};
        volatile int currentPulseWheelIndex = 0;
        volatile unsigned long lastPulseWheelTimeMicros = 0; // Time of last pulse in microseconds, used to calculate pulseIntervalMicros on next pulse

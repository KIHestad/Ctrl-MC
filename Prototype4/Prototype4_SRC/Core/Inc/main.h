...
#define BTN_DEV_BOARD_EXTI_IRQn EXTI15_10_IRQn
#define SW1_IN_Pin GPIO_PIN_0
#define SW1_IN_GPIO_Port GPIOA
#define SW1_DEN_Pin GPIO_PIN_1
#define SW1_DEN_GPIO_Port GPIOA
#define SW1_IS_Pin GPIO_PIN_2
#define SW1_IS_GPIO_Port GPIOA
#define SW2_IS_Pin GPIO_PIN_3
#define SW2_IS_GPIO_Port GPIOA
#define SW2_IN0_Pin GPIO_PIN_4
#define SW2_IN0_GPIO_Port GPIOA
#define SW2_IN1_Pin GPIO_PIN_5
#define SW2_IN1_GPIO_Port GPIOA
#define SW2_DEN_Pin GPIO_PIN_6
...
#define SW3_DEN_Pin GPIO_PIN_0
#define SW3_DEN_GPIO_Port GPIOB
#define SW3_IS_Pin GPIO_PIN_1
#define SW3_IS_GPIO_Port GPIOB
#define SW4_IN0_Pin GPIO_PIN_2
#define SW4_IN0_GPIO_Port GPIOB
#define SW4_IN1_Pin GPIO_PIN_10
#define SW4_IN1_GPIO_Port GPIOB
#define SW4_DEN_Pin GPIO_PIN_11
#define SW4_DEN_GPIO_Port GPIOB
#define SW4_IS_Pin GPIO_PIN_12
#define SW4_IS_GPIO_Port GPIOB
#define SW4_DSEL_Pin GPIO_PIN_13
#define SW4_DSEL_GPIO_Port GPIOB

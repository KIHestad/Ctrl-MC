...
typedef struct {
  ...
  cmc_app_status_code_t status;  // The status of the system, should be CMC_APP_STATUS_SUCCESS when success is true, otherwise should be one of the error status codes that indicate what the error is
} cmc_app_status_t;
